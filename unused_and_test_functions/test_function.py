...
CF_SIGNED_URL_PRIVATE_KEY = CF_SIGNED_URL_PRIVATE_KEY.encode('utf-8')
...
def lambda_handler(event, context):
    url = "https://d26z1cm3nkb7ze.cloudfront.net/images/admin3"
    signed_url = generate_cloudfront_signed_url(url, 600)
